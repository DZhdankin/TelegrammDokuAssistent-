export const page6 = {
  ...
  fields: [
    // 68 Kostaufwändige Ernährung?
    {
      ...
      help_ru:
        "Выберите «Да», если врач назначил вам специальную диету по медицинским показаниям (например диабет, целиакия, тяжёлые заболевания).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 69 Behinderung?
    {
      ...
      help_ru:
        "Выберите «Да», если у вас есть официально подтверждённая инвалидность или Schwerbehindertenausweis.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 70 Leistungen zur Teilhabe am Arbeitsleben?
    {
      ...
      help_ru:
        "Выберите «Да», если вы получаете поддержку для интеграции в трудовую жизнь (например от DRV или Integrationsamt).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 71 Unabweisbarer besonderer Bedarf?
    {
      ...
      help_ru:
        "Выберите «Да», если у вас есть важные расходы, которые нельзя отложить (например срочные медицинские расходы, необходимые вещи).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 72 Stationäre Einrichtung?
    {
      ...
      help_ru:
        "Выберите «Да», если вы проживаете или будете проживать в учреждении с круглосуточным пребыванием (например Krankenhaus, Altenheim, JVA).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    },
    {
      ...
      help_ru: "Введите дату окончания пребывания. Если дата неизвестна — напишите «-».",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "isInStationaryFacility", value: "yes" },
    ...
    // 75 Gesetzlich versichert?
    {
      ...
      help_ru:
        "Выберите «Да», если вы когда-либо были застрахованы в государственной Krankenkasse (например AOK, TK, Barmer).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 78 Wechsel der Krankenkasse?
    {
      ...
      help_ru:
        "Выберите «Да», если вы хотите сменить медицинскую страховку. Jobcenter может помочь с оформлением.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 79 Privat / freiwillig gesetzlich / nicht versichert?
    {
      ...
      help_ru:
        "Выберите «Да», если вы частно застрахованы, добровольно застрахованы в государственной Krankenkasse или не имеете страховки.",
      type: "choice",
      required: true,
      translate: false,
      options: [
