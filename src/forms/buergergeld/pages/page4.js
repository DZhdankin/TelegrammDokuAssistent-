export const page4 = {
  ...
  fields: [
    // 40 Zeitraum Leistungen erhalten
    {
      ...
      label_ru: "Период получения выплат: с (ДД.ММ.ГГГГ) — если не было, можно указать «-»",
      help_ru: "Введите дату начала получения выплат, если вы их получали. Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
    ...
    },
    {
      ...
      label_ru: "Период получения выплат: по (ДД.ММ.ГГГГ) — если не было, можно указать «-»",
      help_ru: "Введите дату окончания получения выплат. Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
    ...
    // 41 Name des Leistungsträgers
    {
      ...
      help_ru: "Введите название организации, которая выплачивала вам пособие (например Jobcenter, Sozialamt). Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: true,
    ...
    // 42–45 Adresse Leistungsträger
    {
      ...
      help_ru: "Введите улицу организации, которая выплачивала пособие. Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: true,
    ...
    },
    {
      ...
      help_ru: "Введите номер дома организации. Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
    ...
    },
    {
      ...
      help_ru: "Введите почтовый индекс организации. Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
    ...
    },
    {
      ...
      help_ru: "Введите город организации. Если выплат не было, можно указать «-».",
      type: "text",
      required: false,
      translate: true,
    ...
    // 46 Angestellt/beschäftigt?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда у вас была официальная работа по трудовому договору за последние 5 лет.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    },
    {
      ...
      help_ru: "Введите дату начала второго периода работы, если он был. Если второго периода не было, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    },
    {
      ...
      help_ru: "Введите дату окончания второго периода работы. Если его не было, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    // 48 Ausstehende Lohnansprüche?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда есть невыплаченная зарплата или другие открытые требования к работодателю.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 49 Arbeitgeber Name
    {
      ...
      help_ru: "Введите название компании, где вы работали. Если не работали, можно указать «-».",
      type: "text",
      required: false,
      translate: true,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    // 50–53 Arbeitgeber Adresse
    {
      ...
      help_ru: "Введите улицу работодателя. Если не работали, можно указать «-».",
      type: "text",
      required: false,
      translate: true,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    },
    {
      ...
      help_ru: "Введите номер дома работодателя. Если не работали, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    },
    {
      ...
      help_ru: "Введите почтовый индекс работодателя. Если не работали, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    },
    {
      ...
      help_ru: "Введите город работодателя. Если не работали, можно указать «-».",
      type: "text",
      required: false,
      translate: true,
      dependsOn: { key: "wasEmployedLast5Years", value: "yes" },
    ...
    // 54 Selbstständig/freiberuflich?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда вы работали как самозанятый, предприниматель или фрилансер.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 55 Entgeltersatzleistungen?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда вы получали выплаты, заменяющие зарплату (например больничные, пособие по безработице, пособие по уходу за ребёнком).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 57 Zeitraum Entgeltersatzleistung
    {
      ...
      help_ru: "Введите дату начала получения выплаты. Обычно её можно сверить с письмами из Krankenkasse или Arbeitsagentur.",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "receivedWageReplacementBenefits", value: "yes" },
    ...
    },
    {
      ...
      help_ru: "Введите дату окончания получения выплаты. Если выплата продолжается или дата окончания неизвестна, можно указать «-».",
      type: "text",
      required: false,
      translate: false,
      dependsOn: { key: "receivedWageReplacementBenefits", value: "yes" },
    ...
    // 58 Wehrdienst/Freiwilligendienst?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда вы проходили военную службу, FSJ (добровольный социальный год) или BFD (федеральная добровольная служба).",
      type: "choice",
      required: true,
      translate: false,
      options: [
