export const page5 = {
  ...
  fields: [
    // 59 Pflege von Angehörigen?
    {
      ...
      help_ru: "Выберите «Да», если вы официально ухаживали за родственником, который нуждается в уходе (Pflegegrad). Это может влиять на выплаты.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 60 Andere Leistungen beantragt?
    {
      ...
      help_ru: "Выберите «Да», если вы уже подали или собираетесь подать на другие социальные выплаты (например Wohngeld, Kindergeld, BAföG).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 62 Welche Leistungen? (multi-choice)
    {
      ...
      help_ru: "Выберите все выплаты, которые вы уже подали или планируете подать. Если нужной выплаты нет — выберите «Sonstiges».",
      type: "multi_choice",
      required: false,
      translate: false,
    ...
    // 63 Schaden durch Dritte?
    {
      ...
      help_ru: "Выберите «Да», если ваше здоровье пострадало из‑за действий другого человека (например ДТП, нападение, врачебная ошибка).",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 64 Anspruch gegenüber Dritten?
    {
      ...
      help_ru: "Выберите «Да», если вы имеете право на компенсацию, страховые выплаты, наследство или другие требования к третьим лицам.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 65 Alleinerziehend?
    {
      ...
      help_ru: "Выберите «Да», если вы один воспитываете ребёнка и несёте основную ответственность за него.",
      type: "choice",
      required: true,
      translate: false,
      options: [
    ...
    // 66 Schwanger?
    {
      ...
      help_ru: "Выберите «Да», если вы беременны. Jobcenter может предоставить дополнительную поддержку.",
      type: "choice",
      required: true,
      translate: false,
      options: [
