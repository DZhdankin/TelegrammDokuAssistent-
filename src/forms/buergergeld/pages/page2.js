export const page2 = {
  ...
  fields: [
    // 17.5 — Есть ли банковский счёт
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда у вас есть банковский счёт в Германии или другой стране ЕС. Вариант «Нет» относится к ситуации, когда счёта нет.",
      options: [
    ...
    // 16 — Kontoinhaber/in
    {
      ...
      help_ru: "Введите имя владельца счёта латиницей, точно как указано в банке. Если счёт принадлежит вам, обычно указывается ваше имя.",
...
,
    // 18 — Есть номер Sozial-/Rentenversicherung?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда у вас есть номер пенсионного или социального страхования (обычно начинается с двух букв и цифр). Если номер неизвестен, можно указать вариант «Нет».",
      options: [
        { value: "yes", label_ru: "Да" },
        { value: "no", label_ru: "Нет" }
      ],
    ...
    // 20 — Есть опекун?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда над вами назначен официальный опекун или Betreuer. Вариант «Нет» относится к ситуации, когда этого нет.",
      options: [
        { value: "yes", label_ru: "Да" },
        { value: "no", label_ru: "Нет" }
      ],
    ...
    // 21 — Дата въезда
    {
      ...
      help_ru: "Введите дату первого въезда в Германию. Если дата неизвестна или поле не относится к ситуации, его можно оставить пустым.",
    ...
    // 22 — Есть ВНЖ?
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда у вас есть действующий Aufenthaltstitel (например, §24, §25, Blaue Karte и т.д.).",
      options: [
        { value: "yes", label_ru: "Да" },
        { value: "no", label_ru: "Нет" }
      ],
    ...
    // 23 — Verpflichtungserklärung
    {
      ...
      help_ru: "Вариант «Да» относится к ситуации, когда кто-то подписывал Verpflichtungserklärung, чтобы пригласить вас в Германию.",
      options: [
        { value: "yes", label_ru: "Да" },
        { value: "no", label_ru: "Нет" }
      ],
    ...
    // 24 — Семейное положение
    {
      ...
      help_ru: "Поле относится к текущему официальному семейному статусу. Вариант «Живём раздельно» относится к ситуации, когда брак формально не расторгнут, но супруги живут отдельно.",
      options: [
          ...
          // 26 — Antragstellung
    {
      ...
      help_ru: "Поле относится к дате начала получения выплат. Вариант «Сразу» означает ближайший возможный момент; вариант «Позже» — конкретную дату.",
      options: [
